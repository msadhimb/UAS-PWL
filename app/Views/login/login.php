...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav  ms-auto">
                    <a class="nav-link" aria-current="page" href="<?php echo base_url('Login/home') ?>">Home</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="container cntnr mt-5">
        <form method="post" action="<?php echo base_url('Login/loginAction') ?>">
            <div class="mb-3">
            ...
            <div class="mb-3 text-end">
                <a href="<?php echo base_url('Login/Register') ?>" class="text-primary text-center">Sign Up</a>
            </div>
